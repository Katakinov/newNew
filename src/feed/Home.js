...
function Home()
{
    return (
        <div className="feed">
            ...
            <Post time={"12:30"} verified={"true"} displayName={"Katakinov"} image={"https://sun9-79.userapi.com/impg/8ddJy_rDtFdWdlkDP2EzWErLa7Bk2Gs91SFaLg/mZMnLXdNnX4.jpg?size=710x1080&quality=95&sign=5867beb66b3a468e0f7f0451c5506de2&type=album"} text={"Доброе утро во Владивостоке, редкий кадр с лисами. Сегодня осень порадовала нас тёплым солнышком и безветренной погодой."} avatar={"https://sun9-45.userapi.com/impg/YB_2xXgEdrSNrY_CIRlIRuRQDdtZ6b-cxnkFKg/1VJ5ExNAqVQ.jpg?size=1080x568&quality=95&sign=452a98a77f57bb3b8cb52a5fd71feac7&type=album"}/>
